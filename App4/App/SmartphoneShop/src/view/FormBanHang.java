...
public class FormBanHang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        maMHLabel.setText("Mã Sách : ");

        tenMHLabel.setText("Tên Sách :");

        danhMucLabel.setText("Loại Sách : ");

        jLabel11.setText("Image :");

        imgLabel.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        hangLabel.setText("Nhà Sản Xuất : ");

        donGiaLabel.setText("Giá Bán : ");

        manHinhLabel.setText("Tác Giả :");

        hdhLabel.setText("Quốc gia :");

        cameraLable.setText("Người biên dịch :");

        cpuLabel.setText("Kích Thước :");

        ramLabel.setText("Mô tả :");

        pinLabel.setText("Ngày xuất bản :");
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(danhMucLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel10, javax.swing.GroupLayout.PREFERRED_SIZE, 569, javax.swing.GroupLayout.PREFERRED_SIZE)

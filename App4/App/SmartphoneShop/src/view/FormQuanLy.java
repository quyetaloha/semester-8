...
public class FormQuanLy extends javax.swing.JFrame {
    ...
    private final String IMG_PATH_WEB = "C:\\Users\\Trinh Nam\\Downloads\\images";
    ...
    private void getDSHoaDon(ArrayList<HoaDon> list) {
        for (HoaDon h : list) {
            ...
            if (h.getMaNV() == 0) {
                modelTableHD.addRow(new Object[]{h.getMaHD(), khachHang.getTenKH(), "NULL", h.getNgayLap(), h.getTotal(), h.getLoaiHD()});
            } else {
    ...
    private void writeFileImg(String filename) {
        ...
        try {
            ...
            f = new File(IMG_PATH_WEB + imgName);
            ImageIO.write(image, "jpg", f);
        } catch (IOException ex) {
            Logger.getLogger(FormQuanLy.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        danhMucCBBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Văn học", "Thiếu nhi", "Tin học" }));

        jLabel16.setText("Tác Giả:");

        jLabel17.setText("Quốc Gia:");

        jLabel18.setText("Người Biên Kịch");

        jLabel19.setText("Kích thước:");

        hdhTF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                hdhTFActionPerformed(evt);
            }
        });

        jLabel2.setText("Mô tả:");

        jLabel9.setText("Ngày Xuất bản:");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(28, 28, 28)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cpuTF, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(cameraTF, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel29.setText("Thêm Sách vào chi nhánh");
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(chiNhanhCBB, 0, 122, Short.MAX_VALUE))
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
            .addGroup(jPanel9Layout.createSequentialGroup()
                .addGap(59, 59, 59)
        ...
        jLabel20.setText("Bảng khách hàng");
        ...
        jPanel15Layout.setVerticalGroup(
            ...
            .addGroup(jPanel15Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jPanel17, javax.swing.GroupLayout.PREFERRED_SIZE, 281, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(userTF)
                            .addComponent(chiNhanhCBBox, javax.swing.GroupLayout.Alignment.TRAILING, 0, 150, Short.MAX_VALUE)
                            .addComponent(passTF))))
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jLabel26.setText("Bảng hiển thị danh sách");
        ...
        jLabel27.setText("Form nhập thông tin nhân viên");
        ...
        jPanel5.getAccessibleContext().setAccessibleName("Form điền thông tin");
        jPanel6.getAccessibleContext().setAccessibleName("Bảng Hiển Thị");
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        if (row == -1) {
            ...
            int confirm = JOptionPane.showConfirmDialog(this, "Bạn chắc chán muốn xóa!", "Thông báo", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int dm = 1;
        if (danhMuc.equals("Thiếu Nhi")) {
            dm = 2;
        } else if (danhMuc.equals("Tin học")) {
            dm = 3;
        }
        if (row == -1) {
            JOptionPane.showMessageDialog(this, "Chưa chọn mặt hàng nào!", "Thông báo", JOptionPane.ERROR_MESSAGE);
...
//        chartPanel.validate();
    ...
    private void hdhTFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hdhTFActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_hdhTFActionPerformed

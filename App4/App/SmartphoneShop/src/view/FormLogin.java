...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Quản lý BookStore");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (nhanVienDAO.checkLogin(user, pass)) {
            ...
            if (nhanVien.getRole().equals("Quản lý server")) {
                FormQuanLy fhs = new FormQuanLy(nhanVien);
                fhs.setVisible(true);
            } else if (nhanVien.getRole().equals("Bán hàng")) {
                FormBanHang fbh = new FormBanHang(nhanVien);
                fbh.setVisible(true);
            } else if(nhanVien.getRole().equals("Quản lý")){

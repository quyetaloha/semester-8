...
public class FormQuanLyCN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        hangLabel.setText("Nhà Sản Xuát : ");

        danhMucLabel.setText("Thể Loại Sách :");

        giaLabel.setText("Giá Bán");
        ...
        cameraLabel.setText("Người biên dịch:");

        cpuLabel.setText("Kích thước:");

        pinLabel.setText("Ngày Sản Xuất:");
        ...
        jLabel2.setText("Tìm hiểu thông tin khách");
        ...
        listItemTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã Sách", "Tên Sách", "Số lượng"
            }
        ));
        ...
        jLabel3.setText("Dánh sách hóa đơn");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (row != -1) {
            ...
            nhanVien.setDiaChi(diaChi);
            nhanVien.setPhone(phone);
            nhanhVienDAO.editNhanVien(nhanVien);
